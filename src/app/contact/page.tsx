                ...
                <div className="lg:pl-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <a href="https://www.ageniqs.com" target="_blank" rel="noopener noreferrer" className="text-brand-blue-400 hover:text-white transition-colors">
                        www.ageniqs.com
                      </a>
                    </div>
                    ...
                    <div className="pt-6 border-t border-gray-800">
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start">
                          <svg className="h-6 w-6 text-brand-blue-400 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                          </svg>
                          <span className="text-gray-400">Response within 1-2 business days</span>
                        </li>
                        <li className="flex items-start">
                          <svg className="h-6 w-6 text-brand-blue-400 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                          </svg>
                          <span className="text-gray-400">Initial consultation to understand your needs</span>
                        </li>
                        <li className="flex items-start">
                          <svg className="h-6 w-6 text-brand-blue-400 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                          </svg>
                          <span className="text-gray-400">Tailored solution recommendations</span>
                        </li>
                        <li className="flex items-start">
                          <svg className="h-6 w-6 text-brand-blue-400 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                          </svg>
                          <span className="text-gray-400">No obligation, no sales pressure</span>
                        </li>
                      </ul>
                    </div>

                    <div className="pt-6 border-t border-gray-800">
                      <h3 className="text-sm font-semibold text-white mb-4">Powered By</h3>
                      <p className="text-gray-400 mb-2">
                        Ageniqs is the U.S. growth arm of{' '}
                        <a href="https://www.thedatapoint.ai/" target="_blank" rel="noopener noreferrer" className="text-brand-blue-400 hover:text-white font-semibold transition-colors">
                          The Data Point
                        </a>
