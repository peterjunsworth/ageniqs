  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 max-w-7xl">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                <div className="inline-flex items-center justify-center rounded-lg bg-brand-blue-100 p-3 mb-4">
                  <svg className="h-6 w-6 text-brand-blue-600" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                ...
                <p className="text-gray-600">Production-ready AI systems designed for real operational environments</p>
              </div>

              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                <div className="inline-flex items-center justify-center rounded-lg bg-brand-purple-100 p-3 mb-4">
                  <svg className="h-6 w-6 text-brand-purple-600" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                ...
                <p className="text-gray-600">Bespoke agentic AI systems tailored to your specific business needs</p>
              </div>
              ...
              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                ...
                <p className="text-gray-600">Measurable operational and revenue outcomes that drive business growth</p>
              </div>
              ...
              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                ...
                <p className="text-gray-600">Backed by The Data Point's engineering expertise and global reach</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              <a href="/solutions/hrtbeat-ai" className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 hover:shadow-card-hover transition-all duration-200">
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-brand opacity-10 rounded-bl-full"></div>
                <h3 className="text-2xl font-display font-bold text-gray-900 mb-4 group-hover:text-gradient transition-all">
                  HRTBeat AI
                </h3>
                ...
                <span className="inline-flex items-center text-brand-blue-600 font-semibold group-hover:gap-2 transition-all">
                  Learn More
              ...
              <a href="/solutions/custom-ai" className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-8 hover:shadow-card-hover transition-all duration-200">
                ...
                <span className="inline-flex items-center text-brand-purple-600 font-semibold group-hover:gap-2 transition-all">
                  Start Your Project
                  <svg className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                  </svg>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-display font-bold tracking-tight text-gray-900 sm:text-4xl mb-4">
