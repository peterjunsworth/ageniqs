...
export default function CustomAIPage() {
  return (
    <div className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-purple-50 via-white to-brand-blue-50 py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center rounded-full px-4 py-2 bg-brand-purple-100 text-brand-purple-700 font-semibold text-sm mb-6">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a
                href="/about"
                className="text-sm font-semibold leading-6 text-gray-900 border border-gray-300 px-6 py-3 rounded-lg hover:border-brand-purple-500 transition-all duration-200"
              >
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Your Challenge Is Unique</h3>
              ...
              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">You Need Competitive Advantage</h3>
                <p className="text-gray-600">
              ...
              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Integration Is Complex</h3>
                <p className="text-gray-600">
                  Your existing systems, data sources, and workflows require deep integration that packaged products can't provide.
                </p>
              </div>
              <div className="rounded-2xl border border-gray-200 p-8 hover:shadow-card-hover transition-shadow duration-200">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Scale Requires Intelligence</h3>
                <p className="text-gray-600">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={index} className="flex items-center rounded-lg border border-gray-200 px-4 py-3 bg-white hover:border-brand-purple-400 transition-colors duration-200">
                  <svg className="h-5 w-5 text-brand-purple-500 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
