        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              <Link href="/solutions/hrtbeat-ai" className="group relative overflow-hidden rounded-3xl border-2 border-gray-200 bg-white p-10 hover:border-brand-blue-400 hover:shadow-2xl transition-all duration-300">
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-brand opacity-10 rounded-bl-full"></div>
                <div className="relative">
                  <div className="inline-flex items-center justify-center rounded-xl bg-brand-blue-100 p-4 mb-6">
                    <svg className="h-8 w-8 text-brand-blue-600" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
                    </svg>
                  </div>
                  <h3 className="text-3xl font-display font-bold text-gray-900 mb-4 group-hover:text-gradient transition-all">
                    HRTBeat AI
                  </h3>
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="flex items-center text-gray-700">
                      <svg className="h-5 w-5 text-brand-blue-500 mr-3" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                  ...
                  <span className="inline-flex items-center text-brand-blue-600 font-semibold text-lg group-hover:gap-2 transition-all">
                    Explore HRTBeat AI
              ...
              <Link href="/solutions/custom-ai" className="group relative overflow-hidden rounded-3xl border-2 border-gray-200 bg-white p-10 hover:border-brand-purple-400 hover:shadow-2xl transition-all duration-300">
                ...
                <div className="relative">
                  <div className="inline-flex items-center justify-center rounded-xl bg-brand-purple-100 p-4 mb-6">
                    <svg className="h-8 w-8 text-brand-purple-600" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                  ...
                  <div className="space-y-3 mb-8">
                    <div className="flex items-center text-gray-700">
                      <svg className="h-5 w-5 text-brand-purple-500 mr-3" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                      </svg>
                  ...
                  <span className="inline-flex items-center text-brand-purple-600 font-semibold text-lg group-hover:gap-2 transition-all">
                    Start Your Project
                    <svg className="ml-2 h-6 w-6 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                    </svg>
